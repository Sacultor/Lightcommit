        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[20px] font-normal text-[#111111] uppercase leading-[80px] font-[family-name:var(--font-agbalumo)]">
                Lightcommit
              </span>
            </div>
            ...
            <div className="flex items-center space-x-12">
              <a href="#discover" className="text-gray-900 font-normal text-2xl hover:text-gray-600 transition-colors font-[family-name:var(--font-abel)]">
                Discover
              </a>
              <a href="#profiles" className="text-gray-900 font-normal text-[27px] hover:text-gray-600 transition-colors font-[family-name:var(--font-abel)]">
                Profiles
              </a>
              <a href="#docs" className="text-gray-900 font-normal text-[27px] hover:text-gray-600 transition-colors font-[family-name:var(--font-abel)]">
                Docs
              </a>
            </div>

            {/* CTA Button */}
            <button className="px-6 py-2.5 border-2 border-black rounded-[39px] backdrop-blur-[13.591px] bg-[rgba(220,220,220,0.3)] hover:bg-[rgba(220,220,220,0.4)] transition-all duration-200 font-normal text-black text-[18px] font-[family-name:var(--font-abel)]">
              <span className="decoration-solid">Start with GitHub</span>
            </button>
          </div>
        </div>
        {/* Bottom border line - 90% width */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 relative">
            <div className="relative">
              ...
              <h1 className="text-6xl font-bold text-gray-900 leading-tight font-[family-name:var(--font-abel)]">
                Own Your Contribution
              </h1>
            </div>

            <p className="py-12 text-3xl text-gray-900 leading-relaxed max-w-md font-[family-name:var(--font-abel)]">
              Build your developer portfolio <br />
              with verifiable, on-chain proof of <br />
              your work.
            </p>

            <button className="px-8 py-3 border-2 border-black rounded-[39px] backdrop-blur-[13.591px] bg-[rgba(220,220,220,0.3)] hover:bg-[rgba(220,220,220,0.4)] transition-all duration-200 font-normal text-black text-[18px] shadow-lg hover:shadow-xl font-[family-name:var(--font-abel)]">
          ...
          <div className="relative">
            ...
            <div className="relative mx-auto max-w-md">
              <div className="relative h-[50vh] bg-[rgba(220,220,220,0.3)] backdrop-blur-[13.591px] border-2 border-black rounded-[60px] p-8 shadow-[0px_60px_40px_0px_rgba(0,0,0,0.1)] flex flex-col justify-between main-card">
                ...
                <div className="text-center mb-4">
                  <p className="text-[21px] text-[#767676] tracking-[1px] leading-[30px] font-[family-name:var(--font-aboreto)]">
                    your-org/your-repo
                  </p>
                </div>
                ...
                {/* Commit Info */}
                <div className="text-center mb-4">
                  <h3 className="text-[29.2px] text-black leading-normal font-[family-name:var(--font-abril-fatface)]">
                    Commit #a1b2c3d
                  </h3>
                </div>
                ...
                <div className="text-center mb-6">
                  <p className="text-[16.04px] text-black leading-[30px] font-[family-name:var(--font-abel)]">
                    +250 lines, -80 lines
                  </p>
                </div>
                ...
                <div className="flex justify-center">
                  <button className="px-12 py-3 bg-black border-2 border-black rounded-[39px] text-white text-[20px] leading-normal font-[family-name:var(--font-abril-fatface)] hover:bg-gray-800 transition-all duration-200">
                    Verifiable on-chain
                  </button>
                </div>
              </div>
            ...
            <p className="pt-20 text-center text-2xl text-black font-normal tracking-[1.2px] leading-[30px] font-[family-name:var(--font-gilroy)]">
